...
TABS = [
    ...
    ("typo",      "差異1·序號登記差異", ["保單號", "保險起日", "產品種類", "保險序號", "EPB序號去S", "EPB單據", "相似度"], True),
    ("only_ins",  "差異2·保險有/EPB無", ["保單號", "保險起日", "產品種類", "序號"], True),
    ("only_epb",  "差異3·EPB有/保險無", ["DOC_ID", "品類", "SAcare品項", "EPB序號去S"], True),
    ("excess",    "差異4·EPB多打/無序號", ["DOC_ID", "品類", "SAcare品項"], True),
    ("deposit",   "差異5·訂金", ["DOC_ID", "品類", "SAcare品項", "EPB序號去S", "保險已登記"], True),
